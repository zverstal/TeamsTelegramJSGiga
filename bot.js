...
Если в сообщении видишь RE, то это ответ на предыдущее письмо. Постарайся уловить контекст оригинала и ответа на оригинал. 
В резюме укажи:
1. Отправителя (email). Постарайся найти ФИО, должность, компанию (по подписи, домену почты и т. д.). Если не можешь найти, то отправляй только email.
